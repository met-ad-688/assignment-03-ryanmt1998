...
https://github.com/met-ad-688/assignment-03-ryanmt1998.git
...
# )
# fig1.show()
# fig1.write_html("output/q_1a_Experience_vs_Salary_by_Education_Level_Bachelors.html")
# fig1.write_image("output/q_1a_Experience_vs_Salary_by_Education_Level_Bachelors.svg", width=1100, height=900, scale=1)

```

![](figures/q_1a_Experience_vs_Salary_by_Education_Level_Bachelors.svg)
...
# )
# fig2.show()
# fig2.write_html("output/q_1a_Experience_vs_Salary_by_Education_Level_Masters.html")
# fig2.write_image("output/q_1a_Experience_vs_Salary_by_Education_Level_Masters.svg", width=1100, height=900, scale=1)

```


![](figures/q_1a_Experience_vs_Salary_by_Education_Level_Masters.svg)
...
![](figures/Bachelors_or_Lower_Histogram.svg)
...
![](figures/Masters_or_PHD_Histogram.svg)
...
![](figures/Experience_vs_Salary_by_Remote_Work_Type.svg)
...
![](figures/Experience_vs_Salary_by_Remote_Work_Type_Hybrid.svg)
...
![](figures/Experience_vs_Salary_by_Remote_Work_Type_Onsite.svg)
...
# plt.savefig("output/Salary_Distribution_Remote.png")
# plt.show()
...
![](figures/Salary_Distribution_Remote.png)
...
# plt.ylabel('Frequency')
# plt.grid(axis='y', alpha=0.7)
# plt.savefig("output/Salary_Distribution_Hybrid.png")
# plt.show()
...
![](figures/Salary_Distribution_Hybrid.png)
...
# plt.ylabel('Frequency')
# plt.grid(axis='y', alpha=0.7)
# plt.savefig("output/Salary_Distribution_Onsite.png")
# plt.show()
...
![](figures/Salary_Distribution_Onsite.png)